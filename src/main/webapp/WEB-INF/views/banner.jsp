			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-12 text-center">
						<a href="/main.food" class="site-logo" style="height:60px"> <img src="resources/img/메인.jpeg" 	alt="Image" class="img-fluid"> </a>
					</div>
						...
						<div class="mx-auto">
							<nav class="site-navigation position-relative text-left" role="navigation">
								<ul class="site-menu main-menu js-clone-nav mx-auto d-none pl-0 d-lg-block border-none">
									...
									<li><a href="/chart.food" class="btn btn-outline-success" style="font-family: 'Sunflower', sans-serif;">식품차트</a></li>
									<li><a href="/qna.food" class="btn btn-outline-success" style="font-family: 'Sunflower', sans-serif;">Q & A</a></li>
									<li><a href="/mmwselect.food" class="btn btn-outline-success" style="font-family: 'Sunflower', sans-serif;">다이어리</a></li>
